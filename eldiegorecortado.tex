...
\subsection{RMQ (dynamic and lazy)}
\cppfile{estructuras/rmq.mixed.cpp}
...
\cppfile[15-16]{math/phollards.rho.villa.cpp}
\subsection{Criba}
...
\cppfile[47-76]{math/polinomio.cpp}
...
\cppfile{flow/push.relabel.villa.cpp}
...
\begin{code}
#include <limits>
numeric_limits<T>::max() ::min() ::epsilon()
\end{code}
\subsection*{Muahaha}
\begin{code}
#include <signal.h>
